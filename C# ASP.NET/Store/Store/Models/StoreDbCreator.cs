...
namespace Store.Models
{
    public class StoreDbCreator : DropCreateDatabaseAlways<StoreDbContext>
    {
        protected override void Seed(StoreDbContext context)
        {
            ...
            context.Products.Add(new Product(2, "Беспроводные наушники AWEI A6200", "Blah blah blah", "1.jpeg", 100, 400, 9));
            context.Products.Add(new Product(2, "Наушники Phillips A89", "Blah blah blah", "2.jpeg", 250, 853, 3));
            context.Products.Add(new Product(2, "Наушники Phillips A89", "Blah blah blah", "3.jpeg", 250, 853, 3));
            context.Products.Add(new Product(3, "Беспроводные наушники AWEI Z5", "Blah blah blah", "4.jpeg", 179, 399, 17));
