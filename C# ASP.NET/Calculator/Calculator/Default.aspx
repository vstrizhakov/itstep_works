            ...
            <table style="margin: 0 auto; width:50%; text-align: center;" class="my-4">
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:Button ID="multipleBtn" runat="server" Text="*" OnClick="multipleBtn_Click" />
                        <asp:Button ID="plusBtn" runat="server" Text="+" OnClick="plusBtn_Click" />
                        <asp:Button ID="divideBtn" runat="server" Text="/" OnClick="divideBtn_Click" />
                        <asp:Button ID="difBtn" runat="server" Text="-" OnClick="difBtn_Click" />
                    </td>
                    <td class="auto-style1">
