...
namespace CountriesCities
{
	public partial class Form1 : Form
	{
		...
		public Form1()
		{
			...
			this.DS.Tables["Countries"].TableNewRow += /*delegate*/ (object s, DataTableNewRowEventArgs e) =>/**/
			{
			...
			this.toolStripComboBox1.TextChanged += /*delegate */ (object s, EventArgs e) =>/**/
			{
			...
			this.dataGridView1.DataError += /*delegate */(object s, DataGridViewDataErrorEventArgs e) =>/**/
			{
