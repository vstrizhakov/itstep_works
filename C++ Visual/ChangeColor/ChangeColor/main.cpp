...
int rgb[3];
enum userMsg{UM_CHANGE = WM_USER+1};//создание констаты для пользовательского сообщения 
...
BOOL CALLBACK Color2DlgProc(HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
		...
		SetScrollRange(hRedSb, SB_CTL, 0, 255, FALSE);//задали диапазон для бегунков и значение в о по умолчанию
